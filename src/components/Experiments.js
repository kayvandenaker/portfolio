  ...
  return (
    <div className='page-container'>
        <div className='page-content'>
          ...
          <video controls src="./img/experiments/slider.mp4" type="video/mp4" autoPlay={true} muted loop>Your browser does not support the video tag.</video>
          ...
          <video controls src="./img/experiments/lines.mp4" type="video/mp4" autoPlay={true} muted loop>Your browser does not support the video tag.</video>
          ...
          <video controls src="./img/experiments/kinect.mp4" type="video/mp4" autoPlay={true} muted loop>Your browser does not support the video tag.</video>
          ...
          <video controls src="./img/experiments/kona.mp4" type="video/mp4" autoPlay={true} muted loop>Your browser does not support the video tag.</video>
          ...
          <video controls src="./img/experiments/desktop.mp4" type="video/mp4" autoPlay={true} muted loop>Your browser does not support the video tag.</video>
