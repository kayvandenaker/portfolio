  ...
  return (
    <div className='page-container'>
        <div className='page-content about'>
          ...
          My name is Kay van den Aker (he/him), I'm a designer and technologist who loves to explore interactions in the digital and physical world. I thrive in ambiguous environments by using a hands-on and iterative approach focused on experience prototyping.
